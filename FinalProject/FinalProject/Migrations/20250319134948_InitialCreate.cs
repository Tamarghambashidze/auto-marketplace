    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserDetails", x => x.PhoneNumber);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CarDetails_DriveTrains_DrivetrainId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CarDetails_Transmissions_TransmissionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BoughtCarId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_Cars_BoughtCarId",
                        column: x => x.BoughtCarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarFavourites", x => new { x.CarId, x.FavouriteId });
                    table.ForeignKey(
                        name: "FK_CarFavourites_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CarFavourites_Favourites_FavouriteId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarDetails_DrivetrainId",
                table: "CarDetails",
                column: "DrivetrainId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarDetails_TransmissionId",
                table: "CarDetails",
                column: "TransmissionId");

            migrationBuilder.CreateIndex(
                name: "IX_CarFavourites_FavouriteId",
                table: "CarFavourites",
                column: "FavouriteId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_BoughtCarId",
                table: "Transactions",
                column: "BoughtCarId",
                unique: true);
